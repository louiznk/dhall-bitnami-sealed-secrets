{ SealedSecret = ./types/com.bitnami.v1alpha1.SealedSecret.dhall
, SealedSecretList = ./types/com.bitnami.v1alpha1.SealedSecretList.dhall
...
, Duration = ./types/io.k8s.apimachinery.pkg.apis.meta.v1.Duration.dhall
